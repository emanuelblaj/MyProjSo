 ...
 * 
 * 
 * private ProductFixtures pf = new ProductFixtures(); private Shipment shipment
 * = new Shipment();
 * 
 * @Test void testAdd() throws Exception { shipment.add(pf.door);
 * shipment.add(pf.window);
 * 
 * // assertThat(shipment, contains(pf.door, pf.window)); }
 * 
 * @Test void testReplace() throws Exception{ shipment.add(pf.door);
 * shipment.add(pf.window);
 * 
 ...
 * 
 * @Test void testPrepare() { shipment.add(pf.door);
 * shipment.add(pf.floorPanel); shipment.add(pf.window);
 * 
 * shipment.prepare();
 * 
 ...
 * 
 * 
 * @Test void testIterator() { fail("Not yet implemented"); }
 * 
 * }
 */